...
$invokeUrl = 'https://sxmguodehi.execute-api.us-west-2.amazonaws.com/staging/fortwebkeylic/'+ $Tdid +'/licreserve'
$response = Invoke-RestMethod $invokeUrl -Method Post -Body $json -ContentType 'application/json'
